    ...
    <div className="about-section" id="about">
      <div className="about-me">
        ...
        <p className="para">
          ...
          I'm a Frontend Developer with 1.5 years of experience, specializing in 
          React, TypeScript, and building scalable web applications. Passionate about creating high-performance, production-ready solutions
          from concept to deployment.
        </p>
      </div>
    </div>
